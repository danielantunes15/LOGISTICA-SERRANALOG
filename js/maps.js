...
export class MapManager {
    ...
    initMap(containerId, center = FABRICA_COORDS, zoom = INITIAL_ZOOM) {
    ...
    initDashboardMap() {
        ...
        if (map) {
            // AUMENTADO o iconSize para o marcador da fabrica
    ...
    initCadastroMap(onLocationSelect) {
        // MODIFICADO: Centraliza na fabrica com zoom de cadastro
        const map = this.initMap('map-cadastro-medio', FABRICA_COORDS, INITIAL_CADASTRO_ZOOM);
    ...
    initEditMap(containerId, initialLat, initialLng, onLocationSelect) {
        const initialCoords = initialLat && initialLng ? [initialLat, initialLng] : FABRICA_COORDS;
